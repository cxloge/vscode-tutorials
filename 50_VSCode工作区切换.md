...
![VSCode 工作区切换](image/vscode-workspace-switch-01.gif)
切换窗口
...
![VSCode 工作区切换](image/vscode-workspace-switch-02.gif)
快速切换窗口
...
![VSCode 工作区切换](image/vscode-workspace-switch-03.gif)
切换文件夹

当你按下 Ctrl + R 调出最近打开的文件夹的列表后，也能够按下 Cmd + 回车键，将它在一个新的窗口中打开。

![VSCode 工作区切换](image/vscode-workspace-switch-04.gif)
将文件夹打开在新的窗口中
